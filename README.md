...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.43`、`hazama-state.js?v=2.43`、`hazama-gate-run.js?v=2.43`、`hazama-main.js?v=2.43` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.43` と `hazama-main.js?v=2.43` を参照している
- `hazama-main.js` が `v2.43` で配信される
