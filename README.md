...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.33`、`hazama-state.js?v=2.33`、`hazama-gate-run.js?v=2.33`、`hazama-main.js?v=2.33` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.33` と `hazama-main.js?v=2.33` を参照している
- `hazama-main.js` が `v2.33` で配信される
