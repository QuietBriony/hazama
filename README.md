...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.24`、`hazama-state.js?v=2.24`、`hazama-gate-run.js?v=2.24`、`hazama-main.js?v=2.24` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.24` と `hazama-main.js?v=2.24` を参照している
- `hazama-main.js` が `v2.24` で配信される
