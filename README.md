...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.41`、`hazama-state.js?v=2.41`、`hazama-gate-run.js?v=2.41`、`hazama-main.js?v=2.41` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.41` と `hazama-main.js?v=2.41` を参照している
- `hazama-main.js` が `v2.41` で配信される
