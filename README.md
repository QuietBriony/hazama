...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.27`、`hazama-state.js?v=2.27`、`hazama-gate-run.js?v=2.27`、`hazama-main.js?v=2.27` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.27` と `hazama-main.js?v=2.27` を参照している
- `hazama-main.js` が `v2.27` で配信される
