...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.40`、`hazama-state.js?v=2.40`、`hazama-gate-run.js?v=2.40`、`hazama-main.js?v=2.40` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.40` と `hazama-main.js?v=2.40` を参照している
- `hazama-main.js` が `v2.40` で配信される
