...
for html_name, html in [('index.html', root), ('hazama-index.html', alt)]:
    for asset in [
        'hazama-style.css?v=2.35',
        'hazama-seed.js?v=2.35',
        'hazama-state.js?v=2.35',
        'hazama-gate-run.js?v=2.35',
        'hazama-main.js?v=2.35',
    ]:
...
assert 'Hazama main.js v2.35' in js, 'hazama-main.js バージョンが期待値ではありません'
...
assert 'hazama-pwa-v2.35' in sw and 'PRECACHE_URLS' in sw and 'hazama-depths.json' in sw and 'CACHE_PREFIX' in sw, 'service worker のPWA cache設定が見つかりません'
...
assert 'browser first playable smoke passed' in browser_first_playable and 'optional Playwright' in browser_first_playable and 'won story Ω option should be enabled' in browser_first_playable and 'PWA manifest link is missing' in browser_first_playable and 'hazama-pwa-v2.35' in browser_first_playable, 'browser first playable smoke script が見つかりません'
