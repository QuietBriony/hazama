...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.9`、`hazama-state.js?v=2.9`、`hazama-main.js?v=2.9` の順に読み込みます。

## v2.9 Gate Intelligence + Music Bridge
...
- `index.html` が `hazama-main.js?v=2.9` を参照している
- `hazama-main.js` が `v2.9` で配信される
