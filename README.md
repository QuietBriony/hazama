...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.10`、`hazama-state.js?v=2.10`、`hazama-main.js?v=2.10` の順に読み込みます。

## v2.10 Gate Intelligence + Music Bridge
...
- `index.html` が `hazama-main.js?v=2.10` を参照している
- `hazama-main.js` が `v2.10` で配信される
