...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.34`、`hazama-state.js?v=2.34`、`hazama-gate-run.js?v=2.34`、`hazama-main.js?v=2.34` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.34` と `hazama-main.js?v=2.34` を参照している
- `hazama-main.js` が `v2.34` で配信される
