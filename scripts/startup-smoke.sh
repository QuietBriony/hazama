...
for html_name, html in [('index.html', root), ('hazama-index.html', alt)]:
    for asset in [
        'hazama-style.css?v=2.22',
        'hazama-seed.js?v=2.22',
        'hazama-state.js?v=2.22',
        'hazama-gate-run.js?v=2.22',
        'hazama-main.js?v=2.22',
    ]:
...
assert 'Hazama main.js v2.22' in js, 'hazama-main.js バージョンが期待値ではありません'
...
assert 'GATE_RUN_TURN_LIMIT: 14' in gate, 'v2.22 Gate Run のターン制限が見つかりません'
...
assert '落ち着き' in js and '響き' in js and '立て直し中' in js, 'v2.22 の説明語彙が見つかりません'
