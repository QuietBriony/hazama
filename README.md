...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.12`、`hazama-state.js?v=2.12`、`hazama-main.js?v=2.12` の順に読み込みます。

## v2.12 Gate Run + Music Bridge
...
- `index.html` が `hazama-main.js?v=2.12` を参照している
- `hazama-main.js` が `v2.12` で配信される
