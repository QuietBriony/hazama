...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.21`、`hazama-state.js?v=2.21`、`hazama-main.js?v=2.21` の順に読み込みます。
...
- `index.html` が `hazama-main.js?v=2.21` を参照している
- `hazama-main.js` が `v2.21` で配信される
