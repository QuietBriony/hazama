...
for html_name, html in [('index.html', root), ('hazama-index.html', alt)]:
    for asset in [
        'hazama-style.css?v=2.18',
        'hazama-seed.js?v=2.18',
        'hazama-state.js?v=2.18',
        'hazama-main.js?v=2.18',
    ]:
...
assert 'Hazama main.js v2.18' in js, 'hazama-main.js バージョンが期待値ではありません'
...
assert '落ち着き' in js and '響き' in js and '立て直し中' in js, 'v2.18 の説明語彙が見つかりません'
