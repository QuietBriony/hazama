...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.42`、`hazama-state.js?v=2.42`、`hazama-gate-run.js?v=2.42`、`hazama-main.js?v=2.42` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.42` と `hazama-main.js?v=2.42` を参照している
- `hazama-main.js` が `v2.42` で配信される
