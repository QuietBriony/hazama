...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.26`、`hazama-state.js?v=2.26`、`hazama-gate-run.js?v=2.26`、`hazama-main.js?v=2.26` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.26` と `hazama-main.js?v=2.26` を参照している
- `hazama-main.js` が `v2.26` で配信される
