...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.37`、`hazama-state.js?v=2.37`、`hazama-gate-run.js?v=2.37`、`hazama-main.js?v=2.37` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.37` と `hazama-main.js?v=2.37` を参照している
- `hazama-main.js` が `v2.37` で配信される
