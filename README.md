...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.28`、`hazama-state.js?v=2.28`、`hazama-gate-run.js?v=2.28`、`hazama-main.js?v=2.28` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.28` と `hazama-main.js?v=2.28` を参照している
- `hazama-main.js` が `v2.28` で配信される
