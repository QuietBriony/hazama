...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.15`、`hazama-state.js?v=2.15`、`hazama-main.js?v=2.15` の順に読み込みます。

## v2.15 Full-Bleed Mandala
...
- `index.html` が `hazama-main.js?v=2.15` を参照している
- `hazama-main.js` が `v2.15` で配信される
