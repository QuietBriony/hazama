...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.29`、`hazama-state.js?v=2.29`、`hazama-gate-run.js?v=2.29`、`hazama-main.js?v=2.29` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.29` と `hazama-main.js?v=2.29` を参照している
- `hazama-main.js` が `v2.29` で配信される
