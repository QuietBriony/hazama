...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.44`、`hazama-state.js?v=2.44`、`hazama-gate-run.js?v=2.44`、`hazama-main.js?v=2.44` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.44` と `hazama-main.js?v=2.44` を参照している
- `hazama-main.js` が `v2.44` で配信される
