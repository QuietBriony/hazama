...
for html_name, html in [('index.html', root), ('hazama-index.html', alt)]:
    for asset in [
        'hazama-style.css?v=2.27',
        'hazama-seed.js?v=2.27',
        'hazama-state.js?v=2.27',
        'hazama-gate-run.js?v=2.27',
        'hazama-main.js?v=2.27',
    ]:
...
assert 'Hazama main.js v2.27' in js, 'hazama-main.js バージョンが期待値ではありません'
...
assert 'GATE_RUN_TURN_LIMIT: 14' in gate, 'v2.27 Gate Run のターン制限が見つかりません'
...
assert 'enterOmegaDepth' in js and 'applyRun: false' in js and 'musicWindowReadyForOrigin' in js, 'v2.27 browser hardening hooks が見つかりません'
...
assert 'H境界: 落ち着き' in js and 'N境界: 響き' in js and '道を選ぶ' in js and 'Gate Run / 扉操作' in js, 'v2.27 balance UI labels が見つかりません'
...
assert 'browser first playable smoke passed' in browser_first_playable and 'optional Playwright' in browser_first_playable and 'BGM stop changed story progress' in browser_first_playable, 'browser first playable smoke script が見つかりません'
...
assert '落ち着き' in js and '響き' in js and '立て直し中' in js, 'v2.27 の説明語彙が見つかりません'
