...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.13`、`hazama-state.js?v=2.13`、`hazama-main.js?v=2.13` の順に読み込みます。

## v2.13 Audio Gate + Ω Run
...
- 通常画面のMusic操作は小さい `AUDIO.GATE` に畳み、dev操作はlocalhostのdrawerへ退避する
- 開始/HUB/節目/Ω接近で曼荼羅演出を強め、通常深度では文章を主役にする
...
- `index.html` が `hazama-main.js?v=2.13` を参照している
- `hazama-main.js` が `v2.13` で配信される
