...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.20`、`hazama-state.js?v=2.20`、`hazama-main.js?v=2.20` の順に読み込みます。

## v2.20 First Playable Vertical Slice
...
- `index.html` が `hazama-main.js?v=2.20` を参照している
- `hazama-main.js` が `v2.20` で配信される
