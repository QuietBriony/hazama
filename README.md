...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.39`、`hazama-state.js?v=2.39`、`hazama-gate-run.js?v=2.39`、`hazama-main.js?v=2.39` の順に読み込みます。

## v2.39 Playful Gate Run Polish

v2.39 では、既存 loop と数値バランスを変えず、Gate Run の「今どれを押すと気持ちいいか」を読みやすくしました。
...
- runtime asset更新に合わせて `v2.39` と `hazama-pwa-v2.39` へ同期
...
- `index.html` が `hazama-gate-run.js?v=2.39` と `hazama-main.js?v=2.39` を参照している
- `hazama-main.js` が `v2.39` で配信される
