...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.25`、`hazama-state.js?v=2.25`、`hazama-gate-run.js?v=2.25`、`hazama-main.js?v=2.25` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.25` と `hazama-main.js?v=2.25` を参照している
- `hazama-main.js` が `v2.25` で配信される
