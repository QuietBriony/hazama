...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.38`、`hazama-state.js?v=2.38`、`hazama-gate-run.js?v=2.38`、`hazama-main.js?v=2.38` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.38` と `hazama-main.js?v=2.38` を参照している
- `hazama-main.js` が `v2.38` で配信される
