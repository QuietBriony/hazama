...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.19`、`hazama-state.js?v=2.19`、`hazama-main.js?v=2.19` の順に読み込みます。

## v2.19 Music Companion State Polish
...
- `index.html` が `hazama-main.js?v=2.19` を参照している
- `hazama-main.js` が `v2.19` で配信される
