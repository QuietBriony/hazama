...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.23`、`hazama-state.js?v=2.23`、`hazama-gate-run.js?v=2.23`、`hazama-main.js?v=2.23` の順に読み込みます。
...
- `index.html` が `hazama-gate-run.js?v=2.23` と `hazama-main.js?v=2.23` を参照している
- `hazama-main.js` が `v2.23` で配信される
