...
`index.html` と `hazama-index.html` は `hazama-seed.js?v=2.22`、`hazama-state.js?v=2.22`、`hazama-gate-run.js?v=2.22`、`hazama-main.js?v=2.22` の順に読み込みます。
